...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3537; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3126; // x position of the perpendicular encoder (in tick units) 3126
    }
